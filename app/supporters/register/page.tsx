...
function SupporterRegisterContent() {
  ...
  async function uploadPhoto(file: File) {
    ...
    const fileName = `supporter-${Date.now()}-${file.name}`;
  ...
  async function registerSupporter() {
    ...
    if (!originCommunity.trim()) {
      alert("Please enter your community or city of origin.");
      return;
    }
    ...
    if (existingSupporterError) {
      console.log(existingSupporterError);
      setSubmitting(false);
    ...
    if (selectedBusinessId) {
      window.location.href = `/support/${selectedBusinessId}/participation-agreement`;
    } else {
    ...
    <main className="min-h-screen bg-[#f5f7fb] p-8 text-[#06245c]">
      ...
      <div className="max-w-5xl rounded-3xl bg-white p-10 shadow-xl">
        ...
        <div className="mb-8 rounded-2xl bg-green-50 p-6">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            ...
            <input
              ...
              placeholder="State / Province / Department of Origin"
              className="rounded-xl border p-4"
            />
            ...
            <input
              ...
              placeholder="Community / City of Origin"
              className="rounded-xl border p-4"
            />
          </div>
        </div>
        ...
        <div className="mb-6 rounded-2xl bg-gray-50 p-6">
          ...
          {uploading && (
            <p className="mt-3 font-bold text-blue-600">Uploading photo...</p>
          )}
