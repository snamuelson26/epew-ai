          ...
          <div className="rounded-3xl bg-white p-8 shadow-xl md:p-12">
            <div className="text-center">
              ...
              <p className="mx-auto mt-6 max-w-3xl text-xl leading-relaxed text-gray-700">
                ...
                While your application is under review, please complete
                this short form so EPEW can communicate with you in
                your preferred language and send you important
                application updates, reminders, and entrepreneurship
                information.
              </p>

              <p className="mx-auto mt-4 max-w-3xl text-lg font-semibold text-green-700">
                You do not need to submit another entrepreneur
                application.
              </p>
            </div>
            ...
            {successMessage && (
              <div className="mt-8 rounded-2xl border border-green-200 bg-green-50 p-6 text-green-800">
                <p className="text-lg font-semibold">
                  Thank you. Your communication preferences have been saved successfully.
                </p>

                <p className="mt-4 text-lg leading-relaxed text-gray-700">
                  Please continue by completing the Entrepreneur Information Form
                  to provide additional information about you, your business idea
                  or existing business, your experience, your goals, and the
                  support you may need from EPEW.
                </p>

                <a
                  href="/entrepreneurs/questionnaire"
                  className="mt-6 inline-block rounded-xl bg-green-600 px-7 py-4 text-lg font-black text-white transition hover:bg-[#06245c]"
                >
                  Continue to Entrepreneur Information Form
                </a>
              </div>
            )}
            ...
            >
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-600">
                  If you already submitted an EPEW Entrepreneur
                  Application, please use the same email address.
                </p>
              </div>
              ...
              <label className="flex items-start gap-4 rounded-2xl bg-blue-50 p-6">
                ...
                <span className="text-base leading-relaxed text-gray-700">
                  ...
                  weekly entrepreneurship information, program
                  updates, and related communications using the
                  contact information and preferred method I selected.
                </span>
              </label>
