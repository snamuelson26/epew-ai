...
export default function PartnerForgotPasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const redirectTo =
      `${window.location.origin}/partners/reset-password`;
    ...
    if (error) {
      console.error("Partner password recovery error:", error);
      ...
      <div className="w-full max-w-xl rounded-3xl bg-white p-10 shadow-2xl">
        <div className="text-center">
          ...
          <p className="mt-6 text-xl leading-relaxed text-gray-700">
            Enter the email address associated with your EPEW partner
